...
- App Shell candidate：`driver-pay-pro-v34`。不改 `driverPayApp.v2`、WorkRecord、
  計算、Manifest、Supabase 或正式資料。等待公開 Preview 的實體 iPhone installed
  PWA 冷啟動驗證後，才能標記完成並進入 Production。

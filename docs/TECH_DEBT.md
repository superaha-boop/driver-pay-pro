...
| TD-002 | Service Worker cache names previously included long feature-specific version labels. | Manual release naming was error-prone and obscured which application revision was cached. | P2 | Resolved 2026-07-25 | Resolved; App Shell releases use the short sequential cache, currently `driver-pay-pro-v11`. Release automation remains a separate TD-005 concern. |
...
| TD-023 | Reports period selection and aggregation are embedded in weekly, monthly, trend, and platform renderers. | New comparisons or trends can rescan state, duplicate rules, or diverge across tabs. | P1 | Resolved for weekly/monthly core 2026-07-26 | Partially resolved in Sprint 5B1: weekly/monthly use shared period utilities, one aggregator and one comparison calculator. Platform formal migration remains Sprint 5B2. |

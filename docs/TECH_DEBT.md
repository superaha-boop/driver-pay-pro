...
| TD-002 | Service Worker cache names previously included long feature-specific version labels. | Manual release naming was error-prone and obscured which application revision was cached. | P2 | Resolved 2026-07-25 | Resolved; Calendar releases use the short sequential cache `driver-pay-pro-v10`. Release automation remains a separate TD-005 concern. |
